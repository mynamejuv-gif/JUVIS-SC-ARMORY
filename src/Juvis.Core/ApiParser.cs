...
public static class ApiParser
{
    ...
    public static Item WikiItem(JsonElement e)
    {
        ...
        return new Item { Id = e.S("uuid"), Name = e.S("name"), Category = First(e.S("classification_label"), e.S("type_label"), e.S("type")),
            Manufacturer = e.Get("manufacturer").S("name"), Type = e.S("type"), SubType = e.S("sub_type"), Size = Int(e.Get("size")),
            ...
            Source = "Star Citizen Wiki", Tags = e.Get("tags").Strings(), RequiredTags = e.Get("required_tags").Strings(),
    ...
    public static Item UexItem(JsonElement e) => new() { Id = First(e.S("uuid"), "uex:item:" + e.S("id")), Name = e.S("name"), Category = First(e.S("category"), e.S("section")),
    ...
    public static Vehicle WikiVehicle(JsonElement e)
    {
        ...
        void Visit(JsonElement p, string prefix, int depth)
        {
            ...
            var installed = p.Get("equipped_item").ValueKind == JsonValueKind.Object ? WikiItem(p.Get("equipped_item")) : null;
        ...
        return new(e.S("uuid"), e.S("name"), e.Get("manufacturer").S("name"), e.Get("is_vehicle").Bool() == true,
